...
print s.crimes(lat=addy.latitude, lng=addy.longitude, rad=500).rows
...
print s.parks(lat=addy.latitude, lng=addy.longitude, rad=1000).rows
...
print s.sanitation_complaints(lat=addy.latitude, lng=addy.longitude, rad=1000).rows